...
protocol ClientListenerDelegate {
...
class ClientListener: NSObject, RTCPeerConnectionDelegate, RTCDataChannelDelegate {
...
private extension ClientListener {
